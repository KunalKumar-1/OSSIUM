          ...
          <div className="px-8 py-4">
            <div className="flex justify-between items-center">
              ...
              <Link to="/" className="text-2xl font-bold neon-text flex-shrink-0 mr-8">
                <span className="text-white">OSS</span><span className="text-neon-red">IUM</span>
              </Link>
          ...
          <div className="text-center">
            <div className="flex justify-center items-center space-x-2 mb-2">
              ...
              <p className="text-sm text-dark-700">
                © 2025 <span className="text-neon-blue font-semibold">OSSIUM</span>. Empowering open-source contributors through decentralized governance.
              </p>
            </div>
            <p className="text-xs text-dark-600">
              Built on <span className="text-accent-purple font-medium">Ethereum</span> 
              <span className="mx-2 text-neon-blue">⚡     </span>
              Powered by <span className="text-neon-blue font-medium">Manotaurs</span>
            </p>
          </div>
        </div>
      </footer>
