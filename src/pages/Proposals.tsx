...
const Proposals: React.FC = () => {
  ...
  const fetchProposals = useCallback(async () => {
    ...
    const mockProposals: Proposal[] = [
      {
        id: 1,
        title: "Increase rewards for Bug Fixs by 30%",
        description: "Proposal to increase the base reward for bug fix contributions from 100 OSS to 130 OSS tokens to better incentivize security-focused contributions and attract more talented developers to the ecosystem.",
        proposer: "0x29BC1ED5cDAf3e52a494973c79420f1e94c3b771",
        forVotes: 4,
        againstVotes: 2,
        status: 1, // Passed
        endTime: "2025-06-29 01:23:43",
        hasVoted: false,
        isMock: true
      },
      {
        ...
        proposer: "0x5bc58751e9171299c5009B70C928c0C5b553BEf1",
        forVotes: 5,
        againstVotes: 3,
        status: 0, // Active
        endTime: "2025-06-28 22:49:12",
        hasVoted: false,
        isMock: true
      },
      {
        ...
        proposer: "0xCccFcD3CFB7036dab1f8Acd342F9FC4B37528854",
        forVotes: 7,
        againstVotes: 4,
        status: 0, // Active
        endTime: "2025-06-28 18:48:45",
        hasVoted: true,
        isMock: true
      },
      {
        ...
        proposer: "0x295b058BCEA12AFf0BebDe320bFB1A3bBf079431",
        forVotes: 7,
        againstVotes: 9,
        status: 2, // Failed
        endTime: "2025-06-28 17:23:43",
        hasVoted: false,
        isMock: true
      }
    ];
