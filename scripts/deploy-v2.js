...
async function main() {
  ...
  try {
    ...
    // 3. Deploy DAO (reuse existing or deploy new)
    console.log("3️⃣ Deploying DAO...");
...
`;
    ...
    console.log(`🪙 Token: ${ossTokenAddress}`);
    console.log(`🏆 Rewards V2: ${ossRewardsV2Address}`);
